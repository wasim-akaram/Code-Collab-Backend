/*
 * Code reader note: Exposes REST endpoints for file and folder creation, upload,
 * lookup, content updates, search, move, rename, delete, and restore.
 * Annotations used: @RestController exposes the API, @RequestMapping sets the
 * /files base path, @RequiredArgsConstructor injects the service, and the mapping
 * annotations bind each HTTP operation. @Valid enforces request validation.
 */
