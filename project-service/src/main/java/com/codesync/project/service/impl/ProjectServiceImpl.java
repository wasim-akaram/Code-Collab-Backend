/*
 * Code reader note: Implements project business rules for ownership, visibility, pagination, starring, forking, archiving, membership, and admin actions.
 */
...
public class ProjectServiceImpl implements ProjectService {
    ...
    /**
     * Retrieves all non-archived projects owned by the currently authenticated user.
     * @param pageable Pagination parameters.
     * @return Paginated response containing user's projects.
     */
    @Override
    public PageResponse<ProjectDto> getUserProjects(Pageable pageable) {
        String email = getUser();
        Page<Project> page = projectRepository.findByOwnerEmailAndArchivedFalse(email, pageable);
