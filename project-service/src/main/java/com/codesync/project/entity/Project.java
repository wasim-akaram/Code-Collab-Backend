/*
 * Code reader note: Represents a code project with metadata, owner, visibility,
 * language, and engagement counters.
 * Annotations used: @Entity and @Table map the entity to the database,
 * Lombok annotations generate boilerplate, @NotBlank validates the name,
 * @Enumerated stores visibility as text, and JPA column/index annotations define
