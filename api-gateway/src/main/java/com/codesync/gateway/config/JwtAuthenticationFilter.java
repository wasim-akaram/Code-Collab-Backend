...
public class JwtAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (isPublicPath(path)) {
            ...
            if (authHeader != null && authHeader.startsWith("Bearer ")) {
                try {
                    ...
                    String planVal = claims.get("plan", String.class);
                    ...
                    if (planVal != null && !planVal.isBlank()) {
                        rb.header("X-User-Plan", planVal);
                    }
        ...
        //  Forward user identity, role, AND plan to downstream services
        ...
        if (plan != null && !plan.isBlank()) {
            reqBuilder.header("X-User-Plan", plan);
        }
    ...
    private boolean isPublicPath(String path) {
        return
            ...
            // Payment — public pricing page
            path.equals("/payments/plans") ||
