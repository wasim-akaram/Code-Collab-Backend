 ...
 * Annotations used: @Component registers the task, @RequiredArgsConstructor injects
 * the service, @Slf4j provides logging, and @Scheduled triggers periodic cleanup.
 */
