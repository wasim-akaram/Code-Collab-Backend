/*
 * Code reader note: Handles STOMP WebSocket messages for cursor updates, edits,
 * joins, and leaves during live collaboration.
 * Annotations used: @Controller registers the STOMP handler, @RequiredArgsConstructor
 * injects the dependencies, @MessageMapping binds STOMP destinations,
 * @DestinationVariable reads the session id from the route, @Payload binds message
 * bodies, and @Data generates payload boilerplate.
 */
