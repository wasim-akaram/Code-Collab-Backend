/*
 * Code reader note: Represents a user currently or previously participating in a
 * collaboration session.
 * Annotations used: @Entity and @Table map the class to the database table,
 * Lombok annotations generate boilerplate, @CreationTimestamp records join time,
 * and JPA column annotations define constraints and defaults.
 */
