/*
 * Code reader note: Exposes REST endpoints for submitting executions, reading job
 * history and results, cancellation, language metadata, and stats.
 * Annotations used: @RestController publishes the API, @RequestMapping sets the
 * /executions base path, @RequiredArgsConstructor injects the service, and the
