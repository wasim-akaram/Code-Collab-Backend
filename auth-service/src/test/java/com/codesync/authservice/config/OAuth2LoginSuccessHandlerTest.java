...
class OAuth2LoginSuccessHandlerTest {
    ...
    class GitHubExistingUser {
        ...
        void jwtUsesStoredUserEmailAndRole() throws Exception {
            ...
            // JWT must use stored role (ADMIN), not hard-coded DEVELOPER
            verify(jwtUtil).generateToken("user@example.com", "ADMIN");
        }
    }
    ...
    class RedirectUrl {
        ...
        void jwtGeneratedWithCorrectClaims() throws Exception {
            ...
            verify(jwtUtil).generateToken("claims@example.com", "DEVELOPER");
        }
    }
}
