/*
 * Code reader note: Generates, stores, verifies, and tracks OTP codes in Redis for
 * signup and password reset flows.
 * Annotations used: @Service registers the business service, @RequiredArgsConstructor
 * injects dependencies, and @Slf4j provides logging.
 */
