/*
 * Code reader note: Contains user identity business logic: registration, OTP finalization, login, password changes, profile updates, token refresh/logout, and admin operations.
 */
...
public class AuthService {
    ...
    public java.util.Map<String, Long> getAdminStats() {
        ...
        long active = userRepository.findAll().stream().filter(User::isActive).count();
        long admins = userRepository.findAllByRole("ADMIN").size();
